...
public:
    ...
    virtual glm::vec3 EvaluateReflectedEnergy(const Intersection &isx, const glm::vec3 &outgoing_ray, const glm::vec3 &incoming_ray, Integrator& integrator, unsigned int integrator_depth) = 0;
